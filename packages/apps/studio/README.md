...
<h1 align="center">@axelor/aos-mobile-studio</h1>
...
The purpose of this package is to link with the studio module of the [Axelor Open Suite (AOS)](https://github.com/axelor/axelor-open-suite) ERP. It provides a simplified version of a number of processes available on the webapp. This package is compatible with AOS from version 8.1.0.
...
```bash
yarn add @axelor/aos-mobile-studio
```
...
import {StudioModule} from '@axelor/aos-mobile-studio';

const App = () => {
  return <Application modules={[StudioModule]} mainMenu="auth_menu_user" />;
};
